...
VENDOR="Sollin"
EMAIL=""
SUMMARY="Solling media system"
LICENSE="Copyright"
GROUP="System"
ARCH="i686"
DESCRIPTION="
Sollin media system sets up sol1004 user and installs necessary Java files for LCD display
"
...
OUTPUT=$HOME/rpmbuild/SPECS/${NAME}-${VERSION}.spec
